...
public class ConfigLoader {
    ...
    public ConfigLoader(String configPath) throws IOException {
        ...
        tenencia = Integer.parseInt(props.getProperty("tenencia"));
        ...
        intervaloTabu = Integer.parseInt(props.getProperty("intervaloTabu", "1000"));
        iteracionesTabu = Integer.parseInt(props.getProperty("iteracionesTabu", "10"));
    ...
    public int getIntervaloTabu() { return intervaloTabu; }

    public int getIteracionesTabu() { return iteracionesTabu; }
    ...
    public void printConfig() {
        ...
        System.out.println("intervaloTabu: " + intervaloTabu);
        System.out.println("iteracionesTabu: " + iteracionesTabu);
    }
}