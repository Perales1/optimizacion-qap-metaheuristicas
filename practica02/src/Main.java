...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        if (algoritmo.equals("GREEDY")) {
            // GREEDY no usa semilla en el nombre del archivo
            logFileName = "archivos/logs/" + nombreArchivoBase + "_" + algoritmo + ".txt";
        } else if (algoritmo.equals("GEN") || algoritmo.equals("EST")) {

            logFileName = "archivos/logs/" + nombreArchivoBase + "_" + algoritmo + "_"+ operador + "_E:" + elitismo + "_kBest:" + kbest + "_" + semilla + ".txt" ;
        }
        else {
            // Elegir la semilla en función de la ejecución
        ...
        switch (algoritmo) {
            ...
            case "BL":
                ...
                AlgBL_04_15 busquedaLocal =
                        new AlgBL_04_15(inst, solucionInicial, Integer.parseInt(config.getIteraciones()));
            ...
            case "GEN":
                ...
                AlgGEN_04_15 genetico = new AlgGEN_04_15(
                        inst,
                        solucionGen,
                        config.getSemillas(),
                        config.getposSemilla()
                );
            ...
            case "EST":
                ...
                AlgEST_04_15 estacionario = new AlgEST_04_15(
                        inst,
                        solucionEst,
                        config.getSemillas(),
                        config.getposSemilla()
